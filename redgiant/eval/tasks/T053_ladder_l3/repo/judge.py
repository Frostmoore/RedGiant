"""Giudice esterno L3 — NON modificabile. Controlla i FATTI.
Exit 0 = verified."""
import re
import sys
from pathlib import Path

EXPECTED = {'phoenix_listen_port': '796', 'hydra_retention_days': '331', 'norma_worker_count': '788', 'volans_max_connections': '714'}
