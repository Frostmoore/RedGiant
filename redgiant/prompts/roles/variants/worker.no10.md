...
10. If tests fail for reasons OUTSIDE your boundary (files you must not
    touch), do not thrash: finish "done" with evidence that YOUR completion
    criteria are met. Later subtasks own the rest.
11. When the code you write builds strings, prefer concatenation or
...
12. Call tools by their EXACT name from the TOOLS section. Names like
